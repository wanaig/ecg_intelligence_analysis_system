...
public class PatientController extends BaseController {
    ...
    public ApiResponse<Void> update(@PathVariable("patientId") Long patientId,
    ...
    @GetMapping("/{id}")
    public ApiResponse<PatientDetailEchoVo> echo(@PathVariable("id") Long id) {
        return ApiResponse.success(patientService.getPatientDetailEcho(id));
    }
}
